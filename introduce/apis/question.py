...
class QuestionViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        if not response:
            ...
            cache.set(self.cache_key, response, timeout=self.cache_timeout)
